...
get_timeshift_and_clusters_predecomp = function(subjtrial_density_smooth_array,
                                      ...
                                      gamma)
{
  ...
  tmp = est_timeshift_predecomp(subjtrial_density_smooth_array = subjtrial_density_smooth_array,
