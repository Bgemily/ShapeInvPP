...
main_shapeinvpp_Nclus3 = function(### Parameters for generative model
                        SEED, 
                        N_subj = 100,
                        N_trial = 1,
                        N_clus=2, 
                        ...
                        ...)
{
  ...
  # Remove Cluster 4
  spks_time_mlist = spks_time_mlist[mem_true_vec<=3, ]
  center_density_array_true = center_density_array_true[1:3, , ]
  center_intensity_array_true = center_intensity_array_true[1:3, , ]
  v_true_mat_list[[1]] = v_true_mat_list[[1]][mem_true_vec<=3, ]
  v_true_mat_list[[2]] = v_true_mat_list[[2]][mem_true_vec<=3, ]
  mem_true_vec = mem_true_vec[mem_true_vec<=3]
  clus_true_list = mem2clus(mem_true_vec, N_clus_min = 3)
  N_subj = N_subj/4*3
  
  data_generated$spks_time_mlist = spks_time_mlist
  data_generated$center_density_array_true = center_density_array_true
  data_generated$center_intensity_array_true = center_intensity_array_true
  data_generated$v_mat_list = v_true_mat_list
  data_generated$mem_true_vec = mem_true_vec
  data_generated$clus_true_list = clus_true_list
