                         ...
                         clus_sep = 1)
{
  ...
  if (N_clus==1){
    ...
    center_N_spks_mat[1,1] = N_spks_total*0.7*(0.5)
    center_N_spks_mat[1,2] = N_spks_total*0.7*(0.5)
    center_N_spks_mat[2,1] = N_spks_total*0.8*(0.5-sqrt(max(0,clus_sep-0.5))/(2*sqrt(0.5)))
    center_N_spks_mat[2,2] = N_spks_total*0.8*(0.5+sqrt(max(0,clus_sep-0.5))/(2*sqrt(0.5)))
    if (TRUE){
